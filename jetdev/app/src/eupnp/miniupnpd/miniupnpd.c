...
int upnp_entry();
/* static int upnp_run(int argc, char * * argv); */
// static int upnp_run();
static int upnp_run(int argc, char * * argv);
...
int eupnp_DeviceStart()
{
	/* sudo ./miniupnpd -i /etc/miniupnpd/miniupnpd.conf -a ens33 -d –vv */
	char* argv_define[32] = {"tmp", "-i", "empty.conf", "-a", "ens33", "-d"};
	return upnp_run(6, argv_define);
}
/* === main === */
